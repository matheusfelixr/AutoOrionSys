...
const DEMO_ACCOUNTS = [
  { email: 'ana.souza@autoorion.com.br', perfil: 'admin' },
  { email: 'carlos.mendes@autoorion.com.br', perfil: 'gerente' },
  { email: 'ricardo.alves@autoorion.com.br', perfil: 'tecnico' },
  { email: 'camila.santos@autoorion.com.br', perfil: 'visualizador' },
];
        ...
        <div class="login-card">
          ...
          <div class="login-form">
            <ui-input
              label="E-mail"
              type="email"
              placeholder="seu@autoorion.com.br"
              [required]="true"
              [(ngModel)]="email"
